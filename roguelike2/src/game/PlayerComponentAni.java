...
public class PlayerComponentAni extends Component {
    ...
    public PlayerComponentAni(GameObject _parent) {
        super(_parent);
        dir = Direction.Up;
        ...
        MAXY = 768 - 91;
        try {
            ArrayList<BufferedImage> ay = EngineCore.assetsCenter.getImageList(assetsPlayerSheet);
